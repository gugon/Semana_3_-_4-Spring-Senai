package br.com.futurodev.semana3.security;

import br.com.futurodev.semana3.context.ApplicatonContextLoad;
...
public class JwtTokenAutenticacaoService {
    ...
    public Authentication getAuthentication(HttpServletRequest request){
        ...
        if(token != null){
            ...
            if(user != null){
                UsuarioModel usuario = ApplicatonContextLoad.getApplicationContext()
